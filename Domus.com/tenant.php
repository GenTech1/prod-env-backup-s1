                    ...
                    <div class="section">
                        ...
                        <div style="padding: 24px;">
                            <div style="margin-bottom: 24px; padding: 16px; background: var(--bg-light); border-radius: 8px; border-left: 4px solid var(--primary-color);">
                                ...
                                <div style="font-size: 32px; font-weight: bold; color: var(--primary-color);">$0.00</div>
                                <div style="font-size: 12px; color: var(--text-light); margin-top: 8px;">Last Payment: Never</div>
                            </div>

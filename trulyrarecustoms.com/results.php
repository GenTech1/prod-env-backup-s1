...
if (isset($_GET['word'])) {
	$word = $_GET['word'];
	echo "You searched for: " ."'". htmlspecialchars($word)."'<br>
";
	...
	try {
        ...
        if ($results) {
            ...
            $images = array_values(json_decode($row['image'], true));
                echo "<hr/><br>" ."&nbsp;&nbsp;<a href='product.php?sku=".htmlspecialchars($row['sku'])."'><img style='height:5vw' src='".htmlspecialchars($images[0])."'/></a>". htmlspecialchars($row['name']) . "<br>";

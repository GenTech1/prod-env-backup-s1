...
<script>
  ...
  gtag('config', 'G-Y4MCVJ8B5C');
    ...
    <link rel="stylesheet" href="css/workstations.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   
    <title>Zax | Workstations</title>
</head>
<body> 
    <?php
...
?>
    <section class="top-section">
        <video autoplay muted loop id="bg-video">
            <source src="images/doingWork.mp4" type="video/mp4">
        </video>
        ...
        <div class="overlay-content">
            ...
            <div class="content"> <!-- content is hero-text -->
                    ...
                    <div id="buttons" ><button id="shopButton" onclick="shop2()">Shop</button><button id="customizeButton" onclick="book()">Customize</button></div>
